...
if __name__ == '__main__':
    np.random.seed(42)
    random.seed(42)
    results_lambda = lambda: load_results_gen("/mnt/shared/gpfs/home/ndate2/InsulinPump/results/verification2")
    all_zones_analysis(results_lambda())
    multiple_table_analysis(results_lambda)
    breakpoint()
